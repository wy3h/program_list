...
/**
 * A component with mouse operation for adding and removing squares. 
 *
 */
public class MouseComponent extends JComponent
{
	...
	private Rectangle2D current; // the square containing the mouse point.
	 ...
	 * @param p a point
	 * @return the first square that contain p
	 */
	...
	/**
	 * Removes a square form the collection.
